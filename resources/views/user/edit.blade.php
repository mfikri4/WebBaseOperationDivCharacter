...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Edit akun pengguna') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('user/edit/'.$data->id) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="password" readonly type="password" class="form-control" value="********">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" readonly type="password" class="form-control" value="********">
                            </div>
                        </div>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="{{ url('user/edit_pass/'.$data->id) }}" class="btn btn-info btn-sm">
                                    {{ __('Menu Edit Password') }}
                                </a>
